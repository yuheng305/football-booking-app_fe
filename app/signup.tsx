...
const Signup = () => {
  ...
  const handleSignup = async () => {
    if (!email || !firstName || !lastName || !phone || !password || !confirmPassword || !age) {
    ...
    try {
      ...
      Alert.alert(
        "Đăng ký thành công",
        "Vui lòng xác nhận email của tài khoản mà bạn đã đăng ký trước khi đăng nhập.",
      ...
      >
        ...
        <View className="mb-6">
          <View className="flex-row items-center border-b border-gray-500 py-2">
            <Ionicons name="mail-outline" size={24} color="#3b82f6" className="mr-3" />
            <TextInput
              value={email}
        ...
        <View className="mb-6">
          <View className="flex-row items-center border-b border-gray-500 py-2">
            <Ionicons name="person-outline" size={24} color="#3b82f6" className="mr-3" />
            <TextInput
              value={firstName}
        ...
        <View className="mb-6">
          <View className="flex-row items-center border-b border-gray-500 py-2">
            <Ionicons name="call-outline" size={24} color="#3b82f6" className="mr-3" />
            <TextInput
              value={phone}
        ...
        <View className="mb-6">
          <View className="flex-row items-center border-b border-gray-500 py-2">
            <Ionicons name="calendar-outline" size={24} color="#3b82f6" className="mr-3" />
            <TextInput
              value={age}
              onChangeText={setAge}
              placeholder="Tuổi"
        ...
        <View className="mb-6">
          <View className="flex-row items-center mb-2">
            <Ionicons name="shield-checkmark-outline" size={24} color="#3b82f6" className="mr-3" />
        ...
        <View className="mb-6">
          <View className="flex-row items-center border-b border-gray-500 py-2">
            <Ionicons name="lock-closed-outline" size={24} color="#3b82f6" className="mr-3" />
            <TextInput
              value={password}
        ...
        >
          {isLoading ? (
            ...
            <Text className="text-center text-white font-semibold text-lg">Đăng ký</Text>
          )}
        </TouchableOpacity>
      </KeyboardAwareScrollView>
    </SafeAreaView>
